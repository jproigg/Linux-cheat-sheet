...
1. **Install a package**: Is the command line interface to handle package installation.
...
3. **Check Package Information**: Use show command to get details about a package
...
4. **Update package:**
The update command is used to update a package.
...
5. **Upgrade package:**
The upgrade command is used to upgradea package.
...
6. **Uninstall package:**
    The remove command is used to remove or uninstall a package.
...
7. **Downlaod a package:**
The download command is used to download a package without installing it.

    For RedHat:
    ```cmd
    yum downloadonly package_name
    ```
